...
function preload()
{
	...
	backround_image2 = loadImage("images/space_over.png")
...
function SpawnPlatform() {
	...
	if((gameState==="PLAY")&&(platform.y>700)) {
	...
	if((gameState==="PLAY")&&(platform2.y>700)) {
